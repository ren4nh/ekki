                    ...
                    <Card className={classes.card}>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit(this.onSubmit)}>
                                ...
                                <Field name="confirmPassword" label="Confirme sua senha" type="password" component={customInput} />
                                <br />
                                <Button color="primary" variant="contained" type="submit" fullWidth={true}> Registrar </Button>
                            </form>
                            <br />
                            <div className={classes.cardHeader}>
                                <Typography gutterBottom > Já possui conta? <a href="/login"> <strong> Clique aqui </strong> </a> para realizar login</Typography>
                            </div>
                        </CardContent>
                    </Card>
                </Grid>
